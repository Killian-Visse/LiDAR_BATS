#      /\                 /\    ╔=============================================================================================╗
#     ( \'.__   (\_/)   __.'/ ) ║ 01 - Script d'extraction des modèles numériques de hauteur LiDAR de l'IGN (projet LiDAR HD) ║ 
#      \_.'  '--('.')--'  '._/  ╚=============================================================================================╝
#          `\=/ " \=/`
#           (/|\)
...
# /!\ Bien penser à actualiser le tableau et à le retélécharger si la zip est comprise dans des zones LiDAR qui n'étaient pas encore disponibles à ce moment là /!\'
...
buffertest <- st_read('results/02_script_extraction_nettoyage_chiros//Buffer500VC_cutLIDAR_ta_bocages.gpkg') #Points ou buffer dans lesquels vous voulez extraire les variables LiDAR              
